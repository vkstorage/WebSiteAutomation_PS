...
public class FebRelease2017MobileBugsTestSuite extends BasicMobileTestSuite{
  ...
  public void verifyPLPContentAdditionTest(String PLPURL, String PLPFiles){
		 List<String> cityDocPara = new ArrayList<String>();
			...
			webAppDriver.get(PLPURL);
			webAppDriver.relax(500);
			webAppDriver.verifyElementPresentByXpath("//div[@class='weekly-hours']//p[text()='Office Hours']/following-sibling::p/span[text()='Sat-Sun']");
			webAppDriver.verifyElementPresentByXpath("//div[@class='weekly-hours']//p[text()='Office Hours']/following-sibling::p/span[text()='Mon-Fri']");
			//webAppDriver.verifyElementPresentByXpath("//div[@class='weekly-hours']//p[text()='Access Hours']/following-sibling::p/span[text()='Mon-Fri']");
			//webAppDriver.verifyElementPresentByXpath("//div[@class='weekly-hours']//p[text()='Access Hours']/following-sibling::p/span[text()='Sat-Sun']");
			webAppDriver.clickElementById("location_features");
			if(webAppDriver.verifyElementIsPresentByXpath("//div[@class='plpinfotemplate']//a")){
			countHLinkElementsURl = webAppDriver.findAllElementsByXpath("//div[@class='plpinfotemplate']//a").size();// to
			}
			else
